...
export default async function ISRPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen gap-8 p-8 font-sans">
            <h1 className="text-4xl font-bold text-green-600">Incremental Static Regeneration (ISR)</h1>
            <p className="max-w-xl text-center text-lg text-gray-700 dark:text-gray-300">
                This page is <strong>regenerated every 10 seconds</strong>. Refresh quickly and the image stays the same. Wait 10s using the same shared cache, and it updates.
                <br />
                <span className="text-sm font-mono bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">next: {"{ revalidate: 10 }"}</span>
            </p>
